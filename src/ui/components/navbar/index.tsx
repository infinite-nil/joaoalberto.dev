...
function Navbar() {
  ...
  return (
    <nav className="fixed z-50 w-full overflow-hidden py-4 text-neutral-600">
      <div className="backdrop" />
      <div className="relative z-10 mx-auto flex items-center justify-between px-6 md:max-w-3xl">
